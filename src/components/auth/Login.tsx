...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center">
      ...
      <div className="border-gray-light flex h-[40rem] w-[80%] min-w-[30rem] flex-col items-center justify-center rounded-[1.5rem] border-[0.1rem]">
        <form onSubmit={handleLoginFormSubmit} className="flex flex-col items-center justify-center gap-[1.2rem]">
          <div className="relative flex flex-col">
            <label htmlFor="email" className="text-lg font-semibold">
              이메일 주소
            </label>
            <input type="email" value={email} onChange={handleEmailChange} className="border-gray-light h-[4rem] w-[24rem] rounded-[1rem] border-[0.1rem]" />
          ...
          <div className="relative flex flex-col">
            ...
            <input type={isVisivlePassword ? "text" : "password"} value={password} onChange={handlePasswordChange} className="border-gray-light h-[4rem] w-[24rem] rounded-[1rem] border-[0.1rem]" />
