  ...
  return (
    <>
      <div className="">
        ...
        {/* 하위 탭 버튼들 */}
        <div className="sub-tabs mb-[2rem] mt-[2.7rem] flex justify-between md:justify-around">
          <button
            className={`${activeSubTab === "current" ? "active bg-primary text-white" : "bg-gray-medium text-primary"} rounded-[1rem] px-[1.5rem] py-[0.5rem] text-base md:text-lg`}
            onClick={() => setActiveSubTab("current")}
          >
            현재 내 모임 보기
          </button>
          <button
            className={`${activeSubTab === "past" ? "active bg-primary text-white" : "bg-gray-medium text-primary"} rounded-[1rem] px-[1.5rem] py-[0.5rem] text-base md:text-lg`}
