  ...
  return (
    <div>
      <div className="my-[4rem] flex min-h-[calc(100vh-12rem)] flex-col items-center justify-center md:min-h-[calc(100vh-13.5rem)]">
        ...
        <div className="border-gray-medium flex h-full min-h-[54rem] w-[80%] min-w-[30rem] flex-col items-center justify-center gap-[3rem] rounded-[1.5rem] border-[0.1rem] py-[2rem] md:max-w-[80rem]">
          <form onSubmit={handleAccountEditFormSubmit} className="flex flex-col justify-center gap-[1.5rem] p-[2rem]">
            <div className="relative flex items-center justify-center">
              ...
              <label htmlFor="profileImage" className="bg-primary absolute right-20 bottom-0 flex h-[3rem] w-[3rem] cursor-pointer items-center justify-center rounded-full text-2xl text-white">
                <FaCog />
                <input
                  type="file"
                  id="profileImage"
            ...
            <div className="flex flex-col gap-[0.8rem]">
              <button type="submit" disabled={editUserMutation.isPending} className="bg-secondary-dark flex h-[4rem] w-[24rem] items-center justify-center rounded-[1rem] text-lg">
                변경하기
              </button>
              <Link href="/account">
