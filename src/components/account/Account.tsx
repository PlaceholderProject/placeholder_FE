...
const Account = () => {
  ...
  return (
    <div className="my-[4rem] flex min-h-[calc(100vh-12rem)] flex-col items-center justify-center md:min-h-[calc(100vh-13.5rem)]">
      ...
      <div className="border-gray-medium flex min-h-[54rem] w-[80%] min-w-[30rem] flex-col items-center justify-center gap-[3rem] rounded-[1.5rem] border-[0.1rem] py-[3rem] md:max-w-[80rem]">
        ...
        <div className="flex w-[80%] flex-col items-center gap-[1rem]">
          ...
          <Link href="/account/password-edit" className="bg-secondary-dark flex h-[4.5rem] w-full items-center justify-between rounded-xl px-[2rem] shadow-md">
