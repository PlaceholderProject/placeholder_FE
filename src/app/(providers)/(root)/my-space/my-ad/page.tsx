  ...
  return (
    <div>
      <div className="sub-tabs">
        <button className={`${activeSubTab === "current" ? "active bg-[#006B8B] text-white" : "bg-[#D9D9D9] text-black"} m-4 rounded-md p-2 font-semibold`} onClick={() => setActiveSubTab("current")}>
          현재 내 광고 보기
        </button>
